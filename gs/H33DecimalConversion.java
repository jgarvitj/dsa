...
public class H33DecimalConversion {
	/**
...
//		divide num and take reminder
//		post decimal
//			store remainder in hashmap <reminder, position>
//			on first repetition, store the num
//			keep dividing till num in back as reminder, add each divisor to intermidiate string
