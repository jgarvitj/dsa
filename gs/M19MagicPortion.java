...
public class M19MagicPortion {

//}
	/*
	 * Question: Combine ingredients in a specific order, any of which may be
	 * repeated
	 * 
	 * As an example, consider the following (A,B,C,D) in 11 steps: A, B, A, B, C,
	 * A, B, A, B, C, E
	 * 
